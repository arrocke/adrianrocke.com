  ...
  <main class="flex-grow">
    ...
    <section class="w-full px-6 sm:px-22 lg:px-24 py-10 bg-white text-grey-darkest">
      ...
      <p class="mt-3 leading-normal">
        ...
        I continued to work at Pivot Interactives part time through college, and generally enjoyed it more than classes.
      </p>
      <h3 class="mt-6">College</h3>
      <p class="mt-3 leading-normal">
