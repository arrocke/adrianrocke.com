<template>
  <main class="flex-grow flex flex-col items-stretch">
    ...
    <div class="section bg-white text-grey-darkest">
      <h2>
        <img
          src="@/assets/pivot.png"
          alt="Pivot Interactives Logo"
        >
        <span>Pivot Interactives</span>
      </h2>
      <a href="//www.pivotinteractives.com">www.pivotinteractives.com</a>
      <p>
      ...
      <ul>
        ...
        <li><span class="font-bold text-sm">FRONTEND:</span> Vue, Sass, Backbone, Handlebars, Webpack</li>
        <li><span class="font-bold text-sm">TESTING:</span> Mocha, Chai, Karma</li>
      </ul>
    </div>
  </main>
</template>
